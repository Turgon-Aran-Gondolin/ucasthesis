...
% \addbibresource{Biblio/papers.bib}%
% \DeclareSourcemap{
%   \maps[datatype=bibtex]{
%     \map[overwrite]{
%       \perdatasource{Biblio/papers.bib}
%       \step[fieldset=keywords, fieldvalue={,papers}, append]
%     }
%   }
% }
\makeatletter
...
\artxifstreq{\artxbib}{bibtex}{% enable bibtex
    ...
    \printbibliography[notkeyword={papers}]% bibliography
}
